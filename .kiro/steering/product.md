...
-   **Auto-sizing font**: il testo del timer riempie automaticamente tutto lo spazio disponibile (binary search + ResizeObserver)
-   **Font Audiowide**: cifre a larghezza uniforme, nessun "saltello" durante il countdown
...
-   **Punteggio per due squadre**: sempre 2 cifre (00, 01, ...), incremento/decremento con bottoni +/-
-   **Loghi squadre selezionabili**: catalogo di squadre italiane di dodgeball
-   **Zoom indipendenti**: scores zoom (solo numeri, non bottoni) e logo zoom (dimensioni reali, non transform)
...
-   Tutto lo stato è salvato in localStorage e ripristinato al reload
...
Layout unico responsive (non più due layout separati):
...
-   Timer sempre in colonna (uno sopra l'altro), mai affiancati
-   Loghi negli angoli in basso (solo desktop), con dimensioni reali che partecipano al layout
-   Menu More si apre verso l'alto su mobile, verso il basso su desktop
